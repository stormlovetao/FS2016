...
int main(int argc, char *argv[]) {
 ...
 //    }
	...
	for(hash_map<std::string, long long int>::iterator it = graphInt.begin(); it!= graphInt.end(); it++)
	{
		...
		//cout<<"graphDegSeq: "<<graphDegSeq<<endl;
	...
	{
		string degreeString = itor->first;
		//cout<< "degreeString: "<<degreeString<<endl;
		// int sumDegree = 0;
		// for (int i = 0; i < subgraphSize; ++i)
		// {
		// 	int degree = AsciiToInt[degreeString[i]] ;
		// 	//cout<<degree<<" ";
		// 	sumDegree = sumDegree + degree + 1;
		// }
		// //cout<<endl;
		// if (sumDegree == 2*subgraphSize-2)//Tree
		// {
		// 	howmanytree += (itor->second).second;
		// }
